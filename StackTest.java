...
public class StackTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Test peek and pop methods
            System.out.println("Peek: " + strStack.peek()); // Should return "Nico", as it's the last pushed
            System.out.println("Pop: " + strStack.pop()); // Should return "Nico"
            System.out.println("Pop: " + strStack.pop()); // Should return "Hanki"
            ...
            System.out.println("Pop: " + strStack.pop()); // Should return "Fabian"
